...
class _ScrollVideoState extends State<ScrollVideo> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final imageNum=scrollStatusNotifier.scrollPos~/10>=120?120:scrollStatusNotifier.scrollPos<=0?0:scrollStatusNotifier.scrollPos~/10; //scroll 속도가 빨라서 10으로 나눠 준다
